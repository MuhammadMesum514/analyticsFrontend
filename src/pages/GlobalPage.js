...
function GlobalPage() {
  ...
  return (
    <PageWrapper>
      <ThemedBackground backgroundColor={transparentize(0.6, '#4dd2ff')} />
      <ContentWrapper>
        <div>
          <AutoColumn gap="24px" style={{ paddingBottom: below800 ? '0' : '24px' }}>
            <TYPE.largeHeader>{below800 ? 'Melega Finance Analytics' : 'Melega Finance Analytics'}</TYPE.largeHeader>
            <Search />
            <GlobalStats />
          </AutoColumn>
