...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://melega.finance//#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://melega.finance//#/swap?inputCurrency=${
...
export function getMiningPoolLink(token0Address) {
  return `https://melega.finance//#/uni/ETH/${token0Address}`
}

export function getUniswapAppLink(linkVariable) {
  let baseUniswapUrl = 'https://melega.finance//#/uni'
  if (!linkVariable) {
