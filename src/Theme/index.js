...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#4dd2ff' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#4dd2ff',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#4dd2ff',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#4dd2ff',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #4dd2ff30 0%, #fff 0%)`,
})
